package com.krisnadwia.bluetoothchatapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText etCreateMessage;
    ...
    private void init() {
        ListView listMainChat = findViewById(R.id.lv_conversation);
        etCreateMessage = findViewById(R.id.et_enter_message);
        ...
        btnSendMessage.setOnClickListener(view -> {
            String message = etCreateMessage.getText().toString();
            if (!message.isEmpty()) {
                etCreateMessage.setText("");
