...
public class DeviceListActivity extends AppCompatActivity {
    ...
    private void init() {
        ListView listPairedDevices = findViewById(R.id.lv_paired_devices);
        ListView listAvailableDevices = findViewById(R.id.lv_available_devices);
        progressScanDevices = findViewById(R.id.pb_scan_devices);
